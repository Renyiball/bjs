...
dsy.add("0_32_0",["澳门半岛","氹仔岛","路环岛","路氹城"]);
dsy.add("0_32",["澳门特别行政区"]);
dsy.add("0_33_0",["台北","高雄","台中","花莲","嘉义","连江","苗栗","南投","屏东","台东","台南","桃园","新竹","宜兰","云林","彰化"]);
dsy.add("0_33_1",["澎湖","兰屿","绿岛","龟山岛","基隆屿","棉花屿","彭佳屿","花瓶屿","琉球屿","七星岩","东沙岛","太平岛","中洲礁","钓鱼岛","金门岛","马祖列岛"]);
dsy.add("0_33",["台湾岛","其他岛"]);
dsy.add("0",["北京市","天津市","上海市","重庆市","河北省","山西省","内蒙古","辽宁省","吉林省","黑龙江省","江苏省","浙江省","安徽省","福建省","江西省","山东省","河南省","湖北省","湖南省","广东省","广西","海南省","四川省","贵州省","云南省","西藏","陕西省","甘肃省","青海省","宁夏","新疆","香港","澳门","台湾省"]);
